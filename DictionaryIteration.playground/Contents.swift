...
// write your code here
var nirvanasAlbum = bandsAndAlbums[bandName]
if let nirvanasAlbum = nirvanasAlbum {
    print("\(bandName)'s top-selling album was \(nirvanasAlbum)")
}
/*: question5
 ...
 */
// write your code here
for (key, value) in bandsAndAlbums {
 ...
 */
// Create a dictionary with Grade level as the key and the score as the value.
/*: question8
 ...
 */
// write your code here
for (grade, score) in scoresByGrade {
...
for (grade, score) in scoresByGrade {
    if score == "A" {
        print("\(grade) got the highest score with an A!")
    }
}
/*:
 [Solution](solution)
